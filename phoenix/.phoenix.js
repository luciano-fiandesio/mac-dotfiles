...
const hyper = 'cmd-alt-ctrl-shift'.split('-')
bind_key('up', 'Top Half', hyper, () => focused().toTopHalf())
bind_key('down', 'Bottom Half', hyper, () => focused().toBottomHalf())
bind_key('left', 'Left side toggle', hyper, () => focused().toLeftToggle())
bind_key('right', 'Right side toggle', hyper, () => focused().toRightToggle())
bind_key('C', 'Center with border', hyper, () => focused().toCenterWithBorder(1))
bind_key('Q', 'Top Left', hyper, () => focused().toTopLeft())
bind_key('A', 'Bottom Left', hyper, () => focused().toBottomLeft())
bind_key('W', 'Top Right', hyper, () => focused().toTopRight())
bind_key('S', 'Bottom Right', hyper, () => focused().toBottomRight())
bind_key('z', 'Right Half', hyper, () => focused().toLeftHalf())
bind_key('x', 'Left Half', hyper, () => focused().toRightHalf())
bind_key('space', 'Maximize Window', hyper, () => focused().toFullScreen())
bind_key('return', 'Maximize Window', hyper, () => focused().toFullScreen())
bind_key('1', 'Show App Name', hyper, showAppName) 
...
// bind_key('M', 'Exit Markdown Editing', hyper, () => {
//   App.focusOrStart(FIREFOX)
